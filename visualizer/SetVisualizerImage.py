...
def SetVisualizerImage(canvas, data):
    ...
    width_px = data["Width"]  * 37.795275591 if data["Width"] else original_image.size[0]
    height_px = data["Height"] * 37.795275591 if data["Height"] else original_image.size[1]
    ...
    canvas.create_image(data["Left"] * 37.795275591 * scale_ratio, data["Top"] * 37.795278891 * scale_ratio, anchor=NW, image=tk_image)
